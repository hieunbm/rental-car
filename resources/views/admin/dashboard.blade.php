...
@section("main")
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card hrm-main-card secondary">
                            <div class="card-body">
                                <div class="d-flex align-items-top">
                                    <div class="me-3">
                                        <span class="avatar bg-secondary"> <i class="ri-user-unfollow-line fs-18"></i> </span>
                                    </div>
                                    <div class="flex-fill">
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header"><div class="card-title">Applicants Summary</div></div>
                            <div class="card-body">
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between align-items-center d-sm-flex d-block">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-primary-light btn-sm btn-wave">1W</button> <button type="button" class="btn btn-primary-light btn-sm btn-wave">1M</button>
                            <button type="button" class="btn btn-primary-light btn-sm btn-wave">6M</button> <button type="button" class="btn btn-primary btn-sm btn-wave">1Y</button>
                        </div>
                    </div>
                    <div class="card-body"><div id="performanceReport"></div></div>
                </div>
            </div>
        </div>
        <!--End::row-1 -->
        ...
        <div class="row">
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-12">
                <div class="card custom-card">
                    <div class="card-header"><div class="card-title">Jobs Summary</div></div>
                    <div class="card-body p-4"><div id="jobs-summary"></div></div>
                    <div class="card-footer p-4 my-2">
                        <div class="row row-cols-12">
                            ...
                            <div class="col p-0">
                                <div class="text-center">
                                    <span class="text-muted fs-12 mb-1 hrm-jobs-legend private d-inline-block ms-2">Private </span>
                                    <div><span class="fs-16 fw-semibold">1,267</span></div>
                                </div>
                            </div>
                            <div class="col p-0">
                                <div class="text-center">
                                    <span class="text-muted fs-12 mb-1 hrm-jobs-legend closed d-inline-block ms-2">Closed </span>
                                    <div><span class="fs-16 fw-semibold">1,153</span></div>
                                </div>
                            </div>
                            <div class="col p-0">
                                <div class="text-center">
                                    <span class="text-muted fs-12 mb-1 hrm-jobs-legend onhold d-inline-block ms-2">On Hold </span>
                                    <div><span class="fs-16 fw-semibold">1,153</span></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <li class="timeline-widget-list">
                                <div class="d-flex align-items-top">
                                    ...
                                    <div class="d-flex flex-wrap flex-fill align-items-top justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <a aria-label="anchor" href="javascript:void(0);" class="p-2 fs-16 text-muted" data-bs-toggle="dropdown"> <i class="fe fe-more-vertical"></i> </a>
            ...
            <div class="col-xxl-5 col-xl-12">
                <div class="card custom-card">
                    <div class="card-header"><div class="card-title">Clients</div></div>
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-3">
                                                <span class="avatar avatar-rounded"> <img src="../a/images/faces/2.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Diana Aise</span> <span class="d-block text-muted fs-12">C.E.O</span></div>
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-3">
                                                <span class="avatar avatar-rounded"> <img src="../dashboard/images/faces/8.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Rose Mary</span> <span class="d-block text-muted fs-12">C.E.O</span></div>
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-3">
                                                <span class="avatar avatar-rounded"> <img src="../dashboard/images/faces/13.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Gretchen Iox</span> <span class="d-block text-muted fs-12">Manager</span></div>
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-3">
                                                <span class="avatar avatar-rounded"> <img src="../dashboard/images/faces/11.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Gray Noal</span> <span class="d-block text-muted fs-12">Manager</span></div>
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row" class="border-bottom-0">
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-3">
                                                <span class="avatar avatar-rounded"> <img src="../dashboard/images/faces/5.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Isa Bella</span> <span class="d-block text-muted fs-12">C.E.O</span></div>
                                        </div>
                                    </th>
                            ...
                            <table class="table table-hover text-nowrap table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded"> <img src="../dashboard/images/faces/4.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Xong Yun</span> <span class="text-muted fs-12">xongyun2134@gmail.com</span></div>
                                        </div>
                                    </td>
                                    <td>14-05-2023</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded"> <img src="../dashboard/images/faces/6.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Kane William</span> <span class="text-muted fs-12">william154@demo</span></div>
                                        </div>
                                    </td>
                                    <td>16-05-2023</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded"> <img src="../dashboard/images/faces/12.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Stewart Rem</span> <span class="text-muted fs-12">remstew092@demo</span></div>
                                        </div>
                                    </td>
                                    <td>21-05-2023</td>
                                    <td><span class="badge bg-success">Paid</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded"> <img src="../dashboard/images/faces/3.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Elliot Yun</span> <span class="text-muted fs-12">eiiliot000@demo</span></div>
                                        </div>
                                    </td>
                                    <td>18-05-2023</td>
                                    <td><span class="badge bg-primary">Overdue</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center lh-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded"> <img src="../dashboard/images/faces/5.jpg" alt="" /> </span>
                                            </div>
                                            <div><span class="d-block fw-semibold mb-1">Gretchen Xio</span> <span class="text-muted fs-12">gretchenxio999@demo</span></div>
                                        </div>
                                    </td>
                                    <td>20-05-2023</td>
                                    <td><span class="badge bg-warning">Pending</span></td>
