...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "YNSXI5ZN"; //Mã website tại VNPAY
    static $vnp_HashSecret = "GKSNDWHVYQOWDPQQLHTQJCPQQVGUMIQL"; //Chuỗi bí mật
    static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static $vnp_Returnurl = "/vnPayCheck"; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
